...
export const SignupForm = ({ onSignup }) => {
    ...
    const validateForm = () => {
        ...
        const failedRules = passwordRules.filter(rule => !rule.regex.test(formData.password));
        if (!formData.password) {
            newErrors.password = 'Password is required';
        } else if (failedRules.length > 0) {
            newErrors.password = 'Password must include ' + failedRules.map(r => r.message).join(', ');
        }
        ...
        <div className="w-full max-w-md min-h-[600px] p-8 bg-white border border-gray-200 rounded-2xl mx-auto flex flex-col justify-center">
            ...
            <div className="mb-4">
                <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 border rounded-lg text-gray-700 focus:outline-none ${errors.gender ? 'border-red-500' : 'border-gray-300'}`}
                >
            ...
            <div className="mb-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none ${errors.password ? 'border-red-500' : 'border-gray-300'}`}
                    />
                    <button
                        type="button"
                ...
                {formData.password && (
                    <div className="mt-2">
                        ...
                        <p className="text-xs text-gray-600 mt-1">{getStrengthLabel(passwordStrength)}</p>
                    </div>
                )}
            </div>
            ...
            <div className="mb-4">
                <div className="relative">
                    ...
                    <input
                        ...
                        className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none ${errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
                    />
                    <button
                        type="button"
            ...
            <button
                ...
                className="w-full bg-[#81AD87] text-white py-3 px-4 rounded-full font-medium transition-transform duration-300 hover:scale-105 mb-4"
            >
                Signup
            </button>
            ...
            <button
                ...
                disabled={false}
                className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 px-4 rounded-full font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
            >
