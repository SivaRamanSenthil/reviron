...
export const LoginForm = ({ onLogin }) => {
  ...
  const handleSubmit = () => {
    ...
    if (Object.keys(newErrors).length === 0) {
      onLogin(formData); // Send to parent
    }
  };
    ...
    <div className="h-3/4">
      <div className="bg-white rounded-2xl border-2 border-gray-200 p-8">
        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none text-gray-700 ${
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full pl-10 pr-12 py-3 border rounded-lg focus:outline-none text-gray-700 ${
        ...
        <div className="text-right mb-6">
          <button type="button" className="text-sm text-gray-400 hover:text-gray-600 focus:outline-none">
            Forgot Password?
          </button>
        </div>
        ...
        <button
          ...
          className="w-full bg-[#81AD87] text-white py-3 px-4 rounded-full font-medium transition-transform duration-300 hover:scale-105 mb-6"
        >
          Login
        </button>
        ...
        <button
          ...
          className="w-full bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 py-3 px-4 rounded-full font-medium transition-colors flex items-center justify-center"
        >
